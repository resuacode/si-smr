...
Ver archivo [CREDENCIALES.md](CREDENCIALES.mdx) para detalles completos.
...
Ver [troubleshooting.md](troubleshooting.mdx) para problemas comunes.
...
- **[CREDENCIALES.md](CREDENCIALES.mdx)** - Todas las credenciales
- **[guia-instalacion.mdx](guia-instalacion.mdx)** - Guía detallada con código
- **[configuracion-proxy.md](configuracion-proxy.mdx)** - Configurar proxy
- **[post-configuracion.md](post-configuracion.mdx)** - Pasos post-instalación
- **[troubleshooting.md](troubleshooting.mdx)** - Resolución de problemas

## 📞 Soporte

Para problemas o sugerencias:
1. Revisar [troubleshooting.md](troubleshooting.mdx)
